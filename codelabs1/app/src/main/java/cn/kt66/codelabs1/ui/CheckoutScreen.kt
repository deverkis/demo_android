...
import cn.kt66.codelabs1.data.OrderUiState
...
fun CheckoutScreenPreview() {
    CheckoutScreen(
        orderUiState = OrderUiState(
            entree = DataLunch.entreeMenuItems[0],
            sideDish = DataLunch.sideDishMenuItems[0],
            accompaniment = DataLunch.accompanimentMenuItems[0],
